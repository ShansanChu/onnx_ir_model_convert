...
import onnx
org_model='opt_ocr3_0_recog_v.onnx'
...
new_onnx_model = fp16.convert_float_to_float16(onnx_model,float_list=[onnx_model.graph.input[-1].name])
#onnx.checker.check_model(new_onnx_model)
save_model(new_onnx_model, 'FP16_fuse_opt_'+'ocr_3_0_recog_v.onnx')
